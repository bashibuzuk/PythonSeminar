...
for i in range(len(list)):
    count_of_cherry = list[i] + list[i-1] + list[i-2]
    if count_of_cherry > result:
        result = count_of_cherry
print(f'Максимальное количество ягод с куста и двух соседних: {result}')
